...
// Date:              Mon Jul 14 21:43:08 2014 (by Create and Import Peripheral Wizard)
...
wire [31:0] output_device_value;
wire [31:0] output_data_value;
wire INEED_change_cache;		
wire [31:0] INEED_Base_Addr;
wire [31:0] INEED_High_Addr;
wire [31:0] INEED_Dout;
wire NEED_change_cache;	//Interrupt the Memory controller to change the cache value
wire NEED_WB_cache; 		//Write back the cache data
wire [31:0] NEED_Base_Addr;
wire [31:0] NEED_High_Addr;
wire [31:0] NEED_Dout;
  // ------------------------------------------------------
...
/*          32'b00000000000000000001000000000000 :
          ...
          default : begin
            slv_reg0 <= slv_reg0; // rst
            slv_reg1 <= output_device_value; // output_device_value
            slv_reg2 <= output_data_value; //output_data_value
            slv_reg3 <= slv_reg3;
            slv_reg4 <= slv_reg4;
            slv_reg5 <= {31'b0,INEED_change_cache};
            slv_reg6 <= INEED_Base_Addr;
            slv_reg7 <= INEED_High_Addr;
            slv_reg8 <= slv_reg8;
            slv_reg9 <= slv_reg9;
            slv_reg10 <= INEED_Dout;
            slv_reg11 <= slv_reg11;
            slv_reg12 <= slv_reg12;
            slv_reg13 <= {31'b0,NEED_change_cache};
            slv_reg14 <= {31'b0,NEED_WB_cache};
            slv_reg15 <= NEED_Base_Addr;
            slv_reg16 <= NEED_High_Addr;
            slv_reg17 <= slv_reg17;
            slv_reg18 <= slv_reg18;
            slv_reg19 <= NEED_Dout;
            slv_reg20 <= slv_reg20;
  ...
  always @( slv_reg_read_sel or slv_reg0 or slv_reg1 or slv_reg2 or slv_reg3 or slv_reg4 or slv_reg5 or slv_reg6 or slv_reg7 or slv_reg8 or slv_reg9 or slv_reg10 or slv_reg11 or slv_reg12 or slv_reg13 or slv_reg14 or slv_reg15 or slv_reg16 or slv_reg17 or slv_reg18 or slv_reg19 or slv_reg20 or slv_reg21 or slv_reg22 or slv_reg23 or slv_reg24 or slv_reg25 or slv_reg26 or slv_reg27 or slv_reg28 or slv_reg29 or slv_reg30 or slv_reg31 )
    begin 
      ...
      case ( slv_reg_read_sel )
        32'b10000000000000000000000000000000 : slv_ip2bus_data <= slv_reg0;//rst
        32'b01000000000000000000000000000000 : slv_ip2bus_data <= slv_reg1;// output_device_value
        32'b00100000000000000000000000000000 : slv_ip2bus_data <= slv_reg2;//output_data_value
        32'b00010000000000000000000000000000 : slv_ip2bus_data <= slv_reg3;//input device value 
        32'b00001000000000000000000000000000 : slv_ip2bus_data <= slv_reg4;//input data value
        ...
        32'b00000000100000000000000000000000 : slv_ip2bus_data <= slv_reg8;//INEED_Addr
        32'b00000000010000000000000000000000 : slv_ip2bus_data <= slv_reg9;//INEED_Din
        32'b00000000001000000000000000000000 : slv_ip2bus_data <= slv_reg10;
        32'b00000000000100000000000000000000 : slv_ip2bus_data <= slv_reg11;//INEED_WE
        32'b00000000000010000000000000000000 : slv_ip2bus_data <= slv_reg12;//INEED_Done
        ...
        32'b00000000000000000100000000000000 : slv_ip2bus_data <= slv_reg17;//NEED_Addr
        32'b00000000000000000010000000000000 : slv_ip2bus_data <= slv_reg18;//NEED_Din
        32'b00000000000000000001000000000000 : slv_ip2bus_data <= slv_reg19;
        32'b00000000000000000000100000000000 : slv_ip2bus_data <= slv_reg20;//NEED_WE
        32'b00000000000000000000010000000000 : slv_ip2bus_data <= slv_reg21;//NEED_Done
  ...
  // ------------------------------------------------------------
CPU_TOP KH32_CPU_TOP(
Bus2IP_Clk,
slv_reg0[0],
output_device_value, 		//output [31:0]//output device value
output_data_value, 			//output [31:0]//output data value 
slv_reg3, 			//input [31:0]//input device value 
slv_reg4, 			//input [31:0]//input data value
INEED_change_cache,		
INEED_Base_Addr,
INEED_High_Addr,
slv_reg8,
...
slv_reg11[0],
slv_reg12[0],
NEED_change_cache,	//Interrupt the Memory controller to change the cache value
NEED_WB_cache, 		//Write back the cache data
NEED_Base_Addr,
NEED_High_Addr,
slv_reg17,
slv_reg18,
